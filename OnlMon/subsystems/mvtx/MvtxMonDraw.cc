...
int MvtxMonDraw::DrawFirst(const std::string & /* what */)
{
 ...
 /*   
  ...
  TH1D * mvtxmon_hist1 = (TH1D *) fin->Get("ChipStave1D"); 
  TH2D * mvtxmon_hist2 = (TH2D *) fin->Get("ChipStaveOcc"); 

  mvtxmon_hist1->SetName("mvtxmon_hist1");
  mvtxmon_hist2->SetName("mvtxmon_hist2");
*/
...
{
  OnlMonClient *cl = OnlMonClient::instance();
//  TH2D *mvtxmon_hist1 = cl->getHisto("mvtxmon_hist2");
//  TH1D *mvtxmon_hist2 = cl->getHisto("mvtxmon_hist2");
/*
  TH1 * mvtxmon_hist3 = cl->getHisto("mvtxmon_hist3");
  TH1 * mvtxmon_hist4 = cl->getHisto("mvtxmon_hist4");
*/
  std::cout << "SUCK New" << std::endl;

      
  TFile * fin = new TFile("/sphenix/user/zshi/PmonYasser/sPHENIX_prototype/online/mvtx_qa/mvtx_QA_pmon/SaveFiles/Run_872.root");
  fin->cd();	

  TH2D * mvtxmon_hist1 = (TH2D *) fin->Get("HitMap_1_4"); 
  TH2D * mvtxmon_hist2 = (TH2D *) fin->Get("ChipStaveOcc"); 
