...
//  mvtxhist2 = new TH2F("mvtxmon_hist2", "test 2d histo", 101, 0., 100., 101, 0., 100.);
  ...
  mvtxhist1 = (TH1D *) fin->Get("InfoCanvas"); 
  //mvtxhist2 = (TH2D *) fin->Get("ChipStaveOcc"); 
 //mvtxhist2 = (TH2D *) fin->Get("ChipStaveOcc"); 
  mvtxhist2 = (TH1D *) fin->Get("EvtHitChip"); 
  mvtxhist3 = (TH1 *) fin->Get("HitMap_1_4"); 
  mvtxhist4 = (TH1 *) fin->Get("ChipStaveOcc"); 

  mvtxhist1->SetName("mvtxmon_hist1");
  mvtxhist2->SetName("mvtxmon_hist2");
  mvtxhist3->SetName("mvtxmon_hist3");
  mvtxhist4->SetName("mvtxmon_hist4");

  OnlMonServer *se = OnlMonServer::instance();
  // register histograms with server otherwise client won't get them
  se->registerHisto(this, mvtxhist1);  // uses the TH1->GetName() as key
  se->registerHisto(this, mvtxhist2);
  se->registerHisto(this, mvtxhist3);
  se->registerHisto(this, mvtxhist4);
